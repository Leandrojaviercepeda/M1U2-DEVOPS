...
class jenkins {
    ...
    } #Reemplazo el puerto de jenkins para que este escuchando en el 8080
    -> exec { 'replace_jenkins_port':
        command => "/bin/sed -i -- 's/JENKINS_PORT=8080/JENKINS_PORT=8080/g' /lib/systemd/system/jenkins.service",
